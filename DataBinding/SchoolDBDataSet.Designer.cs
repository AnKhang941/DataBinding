...
namespace DataBinding.SchoolDBDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([StudentId] = @Original_StudentId) AND ([Ful" +
                "lName] = @Original_FullName) AND ([Age] = @Original_Age) AND ((@IsNull_Major = 1" +
                " AND [Major] IS NULL) OR ([Major] = @Original_Major)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [FullName] = @FullName, [Age] = @Age, [Major] = @Major WHERE (([StudentId] = @Original_StudentId) AND ([FullName] = @Original_FullName) AND ([Age] = @Original_Age) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)));
SELECT StudentId, FullName, Age, Major FROM Students WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBinding.Properties.Settings.Default.SchoolDBConnectionString;
        }
        ...
        public virtual int Insert(string FullName, int Age, string Major) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, int Age, string Major, int Original_StudentId, string Original_FullName, int Original_Age, string Original_Major, int StudentId) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
